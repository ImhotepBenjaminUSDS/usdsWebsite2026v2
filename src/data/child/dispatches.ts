...
const dispatches: Dispatch[] = [
  ...
  },
  {
    ...
    body: "After the emergency fix that restored 1M daily applications, the State Department visa system has been running without incident for 90 days. Monitoring and alerting we built continues to catch issues before users notice.",
