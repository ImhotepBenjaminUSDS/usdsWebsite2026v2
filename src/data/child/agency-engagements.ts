...
const agencyEngagements: AgencyEngagement[] = [
  { name: "Department of Veterans Affairs", domain: "Healthcare", teams: 4, people: 18, status: "active", highlights: ["Claims automation (AI)", "VA.gov redesign", "Health records modernization", "Benefits delivery"] },
  ...
  { name: "Department of Health & Human Services", domain: "Healthcare", teams: 1, people: 5, status: "active", highlights: ["Pandemic preparedness data", "Public health surveillance"] },
  { name: "Department of War", domain: "Defense & Security", teams: 3, people: 12, status: "active", highlights: ["Defense Digital Service", "Logistics modernization", "Cybersecurity infrastructure"] },
  { name: "Department of Homeland Security", domain: "Defense & Security", teams: 2, people: 8, status: "active", highlights: ["USCIS case management", "FEMA disaster response", "Border systems"] },
  ...
  { name: "Department of State", domain: "Immigration & State", teams: 2, people: 9, status: "active", highlights: ["Passport renewal system", "Visa processing infrastructure"] },
  ...
  { name: "Department of Education", domain: "Benefits & Services", teams: 1, people: 6, status: "active", highlights: ["FAFSA modernization", "Student aid systems"] },
  ...
  { name: "Department of Agriculture", domain: "Benefits & Services", teams: 1, people: 4, status: "completed", highlights: ["SNAP benefits modernization", "Farm loan systems"] },
  { name: "Department of Labor", domain: "Benefits & Services", teams: 1, people: 3, status: "completed", highlights: ["Unemployment insurance tech", "Worker safety reporting"] },
];
